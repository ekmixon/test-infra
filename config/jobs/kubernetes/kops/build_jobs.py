            ...
            for distro in distro_options:
                for k8s_version in k8s_versions:
                    results.extend(
                        ...
                        if kops_version is not None
                        or distro not in ["deb9", "rhel7", "u1804"]
                    )
...
def generate_misc():
    return [
        ...
        build_test(
            name_override="kops-grid-scenario-arm64",
            cloud="aws",
            distro="u2004arm64",
            extra_flags=[
                "--zones=eu-central-1a",
        ...
        build_test(
            name_override="kops-aws-cni-calico-ipv6-u2204",
            cloud="aws",
            distro="u2204",
            k8s_version="ci",
            networking="calico",
        ...
        build_test(
            name_override="kops-grid-scenario-no-irsa",
            cloud="aws",
            distro="u2004",
            runs_per_day=3,
            irsa=False,
        ...
        build_test(
            name_override="kops-grid-scenario-aws-cloud-controller-manager",
            cloud="aws",
            distro="u2004",
            k8s_version="ci",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-grid-scenario-terraform",
            terraform_version="1.0.5",
            extra_flags=["--zones=us-west-1a"],
            extra_dashboards=['kops-misc'],
        ),
        build_test(
            name_override="kops-aws-misc-ha-euwest1",
            k8s_version="stable",
            networking="calico",
            kops_channel="alpha",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-misc-arm64-release",
            k8s_version="ci",
            distro="u2004arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-misc-arm64-ci",
            k8s_version="ci",
            distro="u2004arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-misc-arm64-conformance",
            k8s_version="ci",
            distro="u2004arm64",
            networking="calico",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-misc-amd64-conformance",
            k8s_version="ci",
            distro='u2004',
            kops_channel="alpha",
            runs_per_day=3,
        ...
        build_test(
            name_override="kops-aws-misc-updown",
            k8s_version="stable",
            networking="calico",
            distro='u2004',
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-grid-scenario-cilium10-arm64",
            cloud="aws",
            networking="cilium",
            distro="u2004arm64",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-grid-scenario-cilium10-amd64",
            cloud="aws",
            networking="cilium",
            distro="u2004",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-aws-ebs-csi-driver",
            cloud="aws",
            networking="cilium",
            distro="u2004",
            kops_channel="alpha",
        ...
        build_test(
            name_override="kops-aws-keypair-rotation",
            cloud="aws",
            kops_channel="alpha",
            runs_per_day=1,
...
def generate_presubmits_e2e():
    ...
    return [
        ...
        presubmit_test(
            ...
            tab_name='e2e-1-21',
            always_run=True,
            skip_regex=f"{skip_regex}|MetricsGrabber",
        ),
    ]
